            ...
            <div className="booking-widget-section" data-aos="fade-up">
                <div className="container">
                    <div className="booking-widget" data-aos="zoom-in" data-aos-delay="100">
                        <h2 className="section-title" data-aos="fade-down" data-aos-delay="200">Plan Your Stay</h2>
                        <form className="booking-form" data-aos="fade-up" data-aos-delay="300">
                            <div className="form-group" data-aos="fade-right" data-aos-delay="400">
                                ...
                                <input type="date" className="form-control" id="check-in" name="check-in" />
                            </div>
                            <div className="form-group" data-aos="fade-left" data-aos-delay="500">
                                ...
                                <input type="date" className="form-control" id="check-out" name="check-out" />
                            </div>
                            <div className="form-group" data-aos="fade-up" data-aos-delay="600">
                                <label htmlFor="guests" className="form-label">Guests</label>
                                <select id="guests" className="form-select" name="guests">
                        ...
                        <div className="text-center mt-5" data-aos="zoom-in-up" data-aos-delay="700">
                            <button type="submit" className="btn btn-success">Check Availability</button>
                        </div>
                    </div>
                </div>
            </div>
